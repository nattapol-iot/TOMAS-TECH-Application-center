...
import { canonicalPayload, chainHash, demandDocumentClass, demandLocale, evaluateSigningAssurance, isVerifyCodeShape, newVerifyCode, normalizeRevisionLabel, numberPrefix, requireReason, sha256Hex, } from "../src/signing-core.js";
function requestWith(identity) {
    return { identity };
}
