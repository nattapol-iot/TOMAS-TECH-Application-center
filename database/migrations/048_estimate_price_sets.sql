...
EXEC sp_executesql N'ALTER TABLE dbo.cost_items ADD CONSTRAINT CK_cost_price_set CHECK (
...
EXEC sp_executesql N'CREATE UNIQUE INDEX UX_cost_price_set_header ON dbo.cost_items(estimate_id,revision,price_set_key) WHERE is_price_set=1 AND deleted_at IS NULL;';
