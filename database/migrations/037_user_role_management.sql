...
IF NOT EXISTS (SELECT 1 FROM dbo.schema_versions WHERE version = 36)
    THROW 51370, 'Apply migration 036 first.', 1;
GO
...
VALUES (37, N'Admin-managed primary user roles with audited least-privilege writes');
