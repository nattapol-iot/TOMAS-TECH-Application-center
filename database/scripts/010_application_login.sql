...
REVOKE INSERT, UPDATE ON OBJECT::dbo.customers FROM [iot_team_app_role];
REVOKE INSERT, UPDATE ON OBJECT::dbo.suppliers FROM [iot_team_app_role];
REVOKE INSERT, UPDATE ON OBJECT::dbo.engineering_rates FROM [iot_team_app_role];
REVOKE INSERT, UPDATE ON OBJECT::dbo.inquiries FROM [iot_team_app_role];
REVOKE INSERT, UPDATE ON OBJECT::dbo.estimates FROM [iot_team_app_role];
REVOKE INSERT, UPDATE ON OBJECT::dbo.estimate_revisions FROM [iot_team_app_role];
REVOKE INSERT, UPDATE ON OBJECT::dbo.estimate_assignments FROM [iot_team_app_role];
REVOKE INSERT, UPDATE ON OBJECT::dbo.cost_items FROM [iot_team_app_role];
REVOKE INSERT, UPDATE ON OBJECT::dbo.manhour_lines FROM [iot_team_app_role];
REVOKE INSERT, UPDATE ON OBJECT::dbo.expense_lines FROM [iot_team_app_role];
REVOKE INSERT, UPDATE ON OBJECT::dbo.other_cost_lines FROM [iot_team_app_role];
REVOKE INSERT, UPDATE ON OBJECT::dbo.projects FROM [iot_team_app_role];
REVOKE INSERT, UPDATE ON OBJECT::dbo.project_members FROM [iot_team_app_role];
REVOKE INSERT, UPDATE ON OBJECT::dbo.project_folders FROM [iot_team_app_role];
REVOKE INSERT, UPDATE ON OBJECT::dbo.mat_items FROM [iot_team_app_role];
...
REVOKE INSERT, UPDATE ON OBJECT::dbo.boms FROM [iot_team_app_role];
REVOKE INSERT, UPDATE ON OBJECT::dbo.bom_lines FROM [iot_team_app_role];
REVOKE INSERT, UPDATE ON OBJECT::dbo.reservations FROM [iot_team_app_role];
REVOKE INSERT, UPDATE ON OBJECT::dbo.mat_prs FROM [iot_team_app_role];
REVOKE INSERT, UPDATE ON OBJECT::dbo.mat_pr_lines FROM [iot_team_app_role];
REVOKE INSERT, UPDATE ON OBJECT::dbo.mat_pr_approval_steps FROM [iot_team_app_role];
REVOKE INSERT, UPDATE ON OBJECT::dbo.mat_pos FROM [iot_team_app_role];
REVOKE INSERT, UPDATE ON OBJECT::dbo.mat_po_lines FROM [iot_team_app_role];
REVOKE INSERT, UPDATE ON OBJECT::dbo.grns FROM [iot_team_app_role];
REVOKE INSERT, UPDATE ON OBJECT::dbo.grn_lines FROM [iot_team_app_role];
REVOKE INSERT, UPDATE ON OBJECT::dbo.mirs FROM [iot_team_app_role];
REVOKE INSERT, UPDATE ON OBJECT::dbo.mir_lines FROM [iot_team_app_role];
REVOKE INSERT, UPDATE ON OBJECT::dbo.stock_adjustments FROM [iot_team_app_role];
REVOKE INSERT, UPDATE ON OBJECT::dbo.stock_txns FROM [iot_team_app_role];
REVOKE INSERT, UPDATE ON OBJECT::dbo.mat_audit FROM [iot_team_app_role];
REVOKE INSERT, UPDATE ON OBJECT::dbo.holidays FROM [iot_team_app_role];
REVOKE INSERT, UPDATE ON OBJECT::dbo.schedule_tasks FROM [iot_team_app_role];
REVOKE INSERT, UPDATE ON OBJECT::dbo.schedule_task_pics FROM [iot_team_app_role];
REVOKE INSERT, UPDATE ON OBJECT::dbo.schedule_updates FROM [iot_team_app_role];
REVOKE INSERT, UPDATE ON OBJECT::dbo.schedule_baselines FROM [iot_team_app_role];
REVOKE INSERT, UPDATE ON OBJECT::dbo.inquiry_attachments FROM [iot_team_app_role];
REVOKE INSERT, UPDATE ON OBJECT::dbo.inquiry_meetings FROM [iot_team_app_role];
REVOKE UPDATE ON OBJECT::dbo.project_docs FROM [iot_team_app_role];
REVOKE INSERT, UPDATE ON OBJECT::dbo.notifications FROM [iot_team_app_role];

DENY DELETE ON SCHEMA::dbo TO [iot_team_app_role];
