...
const modules = [
 ...
 ['estimate','Estimate Cost','สร้าง revision รายการต้นทุน ค่าใช้จ่าย validation และ workflow','estimates estimate-workspace-read estimate-cost-write estimate-workspace-write','production/EstimateScreens.tsx','estimate|cost-item'],
