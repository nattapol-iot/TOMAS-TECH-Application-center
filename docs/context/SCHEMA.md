...
Evidence: repository migrations at `3e4a891`. Highest file number is not proof of the live DB version. No credentials or connection strings are stored here.
...
| [051_support_email_notification.sql](<../../database/migrations/051_support_email_notification.sql>) | Inspect migration SQL |
