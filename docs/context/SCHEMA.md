...
Evidence: repository migrations at `e2819388`. Highest file number is not proof of the live DB version. No credentials or connection strings are stored here.
