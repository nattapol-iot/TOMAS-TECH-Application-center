...
Evidence: source snapshot `e2819388`; generated, do not edit. [backend-node/src/routes/estimate-assignments-read.ts](<../../../backend-node/src/routes/estimate-assignments-read.ts>). Ranges are hints: search symbol after edits.
