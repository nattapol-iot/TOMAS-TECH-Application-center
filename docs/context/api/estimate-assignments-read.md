...
Evidence: source snapshot `e867e48e`; generated, do not edit. [backend-node/src/routes/estimate-assignments-read.ts](<../../../backend-node/src/routes/estimate-assignments-read.ts>). Ranges are hints: search symbol after edits.
