...
Evidence: source snapshot `4e44d2e`; generated, do not edit. [backend-node/src/routes/knowledge-workflow.ts](<../../../backend-node/src/routes/knowledge-workflow.ts>). Ranges are hints: search symbol after edits.
