...
Evidence: source snapshot `4e44d2e`; generated, do not edit. [backend-node/src/routes/stock-control.ts](<../../../backend-node/src/routes/stock-control.ts>). Ranges are hints: search symbol after edits.
