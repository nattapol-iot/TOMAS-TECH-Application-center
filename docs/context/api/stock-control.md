...
Evidence: source snapshot `6b6809b`; generated, do not edit. [backend-node/src/routes/stock-control.ts](<../../../backend-node/src/routes/stock-control.ts>). Ranges are hints: search symbol after edits.
