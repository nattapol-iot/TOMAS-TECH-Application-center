...
Evidence: source snapshot `4e44d2e`; generated, do not edit. [backend-node/src/routes/knowledge-collaboration.ts](<../../../backend-node/src/routes/knowledge-collaboration.ts>). Ranges are hints: search symbol after edits.
