...
Evidence: source snapshot `84fdd5bc`; generated, do not edit. [backend-node/src/routes/module-templates.ts](<../../../backend-node/src/routes/module-templates.ts>). Ranges are hints: search symbol after edits.
