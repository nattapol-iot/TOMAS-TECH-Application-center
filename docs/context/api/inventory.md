...
Evidence: source snapshot `056c73a4`; generated, do not edit. [backend-node/src/routes/inventory.ts](<../../../backend-node/src/routes/inventory.ts>). Ranges are hints: search symbol after edits.
