...
Evidence: source snapshot `3e4a891`; generated, do not edit. [backend-node/src/routes/inventory.ts](<../../../backend-node/src/routes/inventory.ts>). Ranges are hints: search symbol after edits.
