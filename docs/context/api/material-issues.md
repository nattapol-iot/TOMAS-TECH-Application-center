...
Evidence: source snapshot `e2819388`; generated, do not edit. [backend-node/src/routes/material-issues.ts](<../../../backend-node/src/routes/material-issues.ts>). Ranges are hints: search symbol after edits.
