...
**สำหรับ AI และการแก้โค้ด เริ่มที่ [Project Context](../AGENTS.md)** แล้วเลือกอ่านเฉพาะโมดูล → API/ฟังก์ชันที่ต้องแก้ มี [Architecture](context/ARCHITECTURE.md) และ [วิธีอัปเดต Context](context/WORKFLOW.md) แยกไว้ตามงาน เอกสารสถานะและผลตรวจด้านล่างเป็นหลักฐานตามวันที่ ไม่ใช่การยืนยันสถานะระบบปัจจุบัน
